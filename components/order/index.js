...
export default function Order() {
  return (
    ...
    >
      ...
      <SafeAreaView
        style={{ flex: 1, backgroundColor: "#c4c4c4", position: "relative" }}
      >
        <View style={{ backgroundColor: "#FFf", padding: 15 }}>
          <View style={{ flexDirection: "row" }}>
            ...
            <View style={{ flex: 3 }}>
              ...
              <Text
                style={{ color: "#ee0d0d", fontSize: 18, fontWeight: "700" }}
              >
                141.800 đ
              </Text>
              <Text style={{ color: "#808080", fontSize: 12, marginTop: 8 }}>
                141.800 đ
              </Text>
              <View
                style={{
        ...
        >
          <Text style={{ fontSize: 12, fontWeight: "bold" }}>
            Bạn có phiều quà tặng Tiki/Got iot/ Ur box?
          </Text>
          <Text
            style={{
              fontSize: 12,
        ...
        >
          ...
          <Text style={{ color: "#ee0d0d", fontSize: 18, fontWeight: "700" }}>
            141.800 đ
          </Text>
        </View>
        <View
          style={{ marginTop: "auto", backgroundColor: "#fff", padding: 15 }}
        >
          <View
            style={{
              flexDirection: "row",
          ...
          >
            <Text style={{ fontSize: 20, color: "#999", fontWeight: "500" }}>
              Thành tiền
            </Text>
            <Text style={{ color: "#ee0d0d", fontSize: 18, fontWeight: "700" }}>
              141.800 đ
